...
for key in fof.data.subfind_tab.FOF:
    read.pprint(key, len(fof.data.subfind_tab.FOF[key]), fof.data.subfind_tab.FOF[key][:2])

for key in fof.data.subfind_tab.Subhalo:
    read.pprint(key, len(fof.data.subfind_tab.Subhalo[key]), fof.data.subfind_tab.Subhalo[key][:2])

for key in fof.data.group_tab.FOF:
    read.pprint(key, len(fof.data.group_tab.FOF[key]), fof.data.group_tab.FOF[key][:2])
