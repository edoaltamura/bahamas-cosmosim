...
for key in fof.data.subfind_tab.FOF:
    read.pprint(len(fof.data.subfind_tab.FOF[key]), fof.data.subfind_tab.FOF[key])

for key in fof.data.subfind_tab.Subhalo:
    read.pprint(len(fof.data.subfind_tab.Subhalo[key]), fof.data.subfind_tab.Subhalo[key])
