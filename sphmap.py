...
def scatter(x: float64, y: float64, m: float32, h: float32, res: int) -> ndarray:
    ...
    for x_pos, y_pos, mass, hsml in zip(x, y, m, h):
        ...
        if cells_spanned <= 1:
            ...
            for cell_x in range(particle_cell_x - cells_spanned + 1, particle_cell_x + cells_spanned):
                ...
                for cell_y in range(particle_cell_y - cells_spanned + 1, particle_cell_y + cells_spanned):
                    ...
                    normalisation += kernel_single_precision(r, kernel_width)
            ...
            for cell_x in range(
                ...
                for cell_y in range(
                    ...
                    kernel_eval = normalisation * kernel_single_precision(r, kernel_width)
